...
//clicking add button, adds text to the list
...
function createListItem(item){
    ...
    ulElement.classList.add('list-item');
    ulElement.innerText = item;
    ...
    ulElement.appendChild(buttons);
    container.appendChild(ulElement);    
};

function completeTask(){
    var completedItem = this.parentNode.parentNode;
    completedItem.setAttribute('id','completed');

    var finishedList = document.getElementById("completedItem");
    finishedList.appendChild(completedItem);
    
};

function removeTask(){
    var removeItem = this.parentNode.parentNode;
    var parentItem = removeItem.parentNode;
